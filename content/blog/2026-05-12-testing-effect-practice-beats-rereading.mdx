...
Decades of research back this up. In the best-known study, [Roediger and Karpicke (2006)](https://en.wikipedia.org/wiki/Testing_effect) had students either re-read a passage or take a practice test on it. A week later, the group that had been tested remembered substantially more, even though the re-reading group had *felt* more confident. The effect compounds — every retrieval makes the next retrieval easier and stronger.
...
<Callout type="tip">
StudyAce generates exam-style practice questions from your syllabus and marks them honestly — no leniency, no false praise. That's the retrieval step, automated. [Take the free grade check](/grade) to see what you'd get if you sat the exam today, then fix the gaps it finds.
</Callout>
