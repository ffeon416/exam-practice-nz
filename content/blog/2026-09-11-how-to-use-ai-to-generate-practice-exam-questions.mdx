...
If you find the AI's answer was wrong, that's not a wasted exercise. Catching it is a very strong form of [retrieval practice](https://en.wikipedia.org/wiki/Testing_effect). You just can't let the errors slide past unnoticed.
