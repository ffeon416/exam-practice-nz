...
export const demoResults: MarkingResult[] = [
  {
    ...
    grade: "excellence",
    feedback:
      "Great answer! You've correctly described photosynthesis as the process where plants use sunlight to convert CO₂ and water into glucose and oxygen. You've also explained why it matters — providing oxygen and energy for living things. Full marks: 1 for your working, 1 for the answer.",
    correctApproach:
  ...
  },
  {
    ...
    grade: "excellence",
    feedback:
      "Well done! You've correctly identified the pattern (each row adds 3 seats) and applied it to find row 12 = 53 seats. Your working is clear and the final answer is correct — 1 mark each.",
    correctApproach:
  ...
  },
  {
    ...
    grade: "excellence",
    feedback:
      "Excellent analysis! You've identified multiple language techniques with specific evidence from the text and explained how each creates a sense of loss. Your use of quotations is well-integrated and your explanations show genuine understanding of the writer's craft. Full marks: 1 for your method (techniques + evidence), 1 for the answer.",
    correctApproach:
