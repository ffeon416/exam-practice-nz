...
export const CURRICULA: Curriculum[] = [
  ...
  },
  {
    ...
    yearLevels: ["Year 10", "Year 11", "Year 12"],
    gradeBands: [
      // VCE study scores are scaled 0–50; bands here approximate letter-grade
      // cut-offs used on assessments. Refined during the VCE build.
      { id: "a-plus", label: "A+", minPct: 0.9 },
      { id: "a", label: "A", minPct: 0.8 },
      { id: "b", label: "B", minPct: 0.7 },
      { id: "c", label: "C", minPct: 0.55 },
      { id: "d", label: "D", minPct: 0.4 },
      { id: "e", label: "E", minPct: 0 },
    ],
    status: "coming-soon",
